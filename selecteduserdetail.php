    ...
    if (($amount)<0)
   {
    ...
    // constraint to check zero values
         ...
         echo "</script>";
                ...
                $sender = $sql1['name'];
                $receiver = $sql2['name'];
                $sql = "INSERT INTO transferhistory(`sender`, `receiver`, `balance`) VALUES ('$sender','$receiver','$amount')";
                $query=mysqli_query($conn,$sql);
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <title>Make easy Transaction</title>
...
<body style="background-color : #BAC7A7 ;">


	<div class="container">
        <h2 class="text-center pt-4" style="color : black;">Make Easy Transaction</h2>
            <?php
                include 'config.php';
                $sid=$_GET['id'];
        ...
        <div>
            <table class="table table-hover table-sm table-striped table-condensed table-bordered" style="border-color:black;">
                <tr style="color : black;">
                    ...
                    <th class="text-center"> Balance( Rs.)</th>
                </tr>
                <tr style="color : black;">
        ...
        <br>
            ...
            <button class="btn mt-3" name="submit" type="submit" id="myBtn" style="color: white;">Transfer Money</button>
            </div>
        </form>
    </div>
